...
// To start off the api call has to be handled by the server and piped to the client for security reasons.
// Once the data is fetched and stored in the global redux store, we can pull the necessary content
// at any layer of the application. I'd suggest still keep on the container directory for a better
